namespace Entity.DTO
{
    ...
    public static class BuyOrderExtentions
    {
        ...
        /// <summary>
        /// Converts a BuyOrderResponse object to a OrderResponse object.
        /// </summary>
        /// <param name="buyOrderResponse">The BuyOrderResponse object to convert.</param>
        /// <returns>A new OrderResponse object initialized from the BuyOrderResponse.</returns>
        public static OrderResponse ToOrderResponse(this BuyOrderResponse buyOrderResponse)
        {
            return new OrderResponse
            {
                ...
                TradeAmount = buyOrderResponse.Quantity * buyOrderResponse.Price
            };
        }
    }
}
