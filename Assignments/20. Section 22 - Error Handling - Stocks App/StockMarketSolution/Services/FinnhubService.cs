...
namespace Service
{
    ...
    public class FinnhubService : IFinnhubService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FinnhubService"/> class.
        /// </summary>
        /// <param name="httpClientFactory">Factory for creating HTTP clients.</param>
        /// <param name="configuration">Configuration settings.</param>
        /// <param name="finnhubToken">API token for Finnhub.</param>
        public FinnhubService(IHttpClientFactory httpClientFactory, IConfiguration configuration, string finnhubToken)
        {
