...
namespace StockMarketSolution.Controllers
{
    ...
    public class TradeController : Controller
    {
        ...
        public async Task<IActionResult> Index(string stockSymbol = "")
        {
            ...
            var getStockPriceQuoteResponseDictionary = await _finnhubService.GetStockPriceQuote(stockSymbol);
            ...
            var getCompanyProfileResponseDictionary = await _finnhubService.GetCompanyProfile(stockSymbol);
