...
namespace StockMarketSolution.Controllers
{
    ...
    public class TradeController : Controller
    {
        ...
        /// </summary>
        /// <param name="finnhubCompanyProfileService">Service for fetching company profile information.</param>
        /// <param name="finnhubStockPriceQuoteService">Service for fetching stock price quotes.</param>
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var getStockPriceQuoteResponseDictionary = await _finnhubStockPriceQuoteService.GetStockPriceQuote(_tradingOptions.DefaultStockSymbol);
            ...
            var getCompanyProfileResponseDictionary = await _finnhubCompanyProfileService.GetCompanyProfile(_tradingOptions.DefaultStockSymbol);
